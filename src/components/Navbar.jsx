      ...
      <div className="flex justify-between items-center h-18 px-7 max-w-[1340px] mx-auto">
        ...
        >
          <ul className="uppercase p-7 flex flex-col items-center mt-24">
            ...
            <li className="mt-4">
              <button onClick={handleGetApp} className="px-8 py-3 cursor-pointer font-semibold text-sm bg-[#054C73] rounded-full text-white transition-colors hover:bg-[#043c5a]">
                Get the app
              </button>
            </li>
          </ul>
