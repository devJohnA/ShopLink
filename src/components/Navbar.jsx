  ...
  return (
    <div className="flex justify-between items-center h-24 px-7 max-w-[1340px] mx-auto font-['sans-serif]">
      ...
      <ul className="hidden md:flex items-center">
        <li className="p-6 cursor-pointer font-semibold text-lg hover:text-[#054C73] transition-colors text-zinc-700">Home</li>
        <li className="p-6 cursor-pointer font-semibold text-lg hover:text-[#054C73] transition-colors text-zinc-700">About</li>
        <li className="p-6 cursor-pointer font-semibold text-lg hover:text-[#054C73] transition-colors text-zinc-700">Categories</li>
        <li className="p-6 cursor-pointer font-semibold text-lg hover:text-[#054C73] transition-colors text-zinc-700">Contact</li>
        <li className="ml-2">
